...
import co.edu.udea.cine.bean.ComentariosFacade;
...
@FacesConverter(value = "comentariosConverter")
public class ComentariosConverter implements Converter {

    @Inject
    private ComentariosFacade ejbFacade;
