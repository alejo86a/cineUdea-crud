...
import co.edu.udea.cine.bean.CarteleraFacade;
...
@FacesConverter(value = "carteleraConverter")
public class CarteleraConverter implements Converter {

    @Inject
    private CarteleraFacade ejbFacade;
    ...
    public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
        ...
        if (object instanceof Cartelera) {
            ...
            return getStringKey(o.getIdCARTELERA());
        } else {
