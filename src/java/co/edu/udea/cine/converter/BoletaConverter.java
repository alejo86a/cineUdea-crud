...
import co.edu.udea.cine.bean.BoletaFacade;
...
@FacesConverter(value = "boletaConverter")
public class BoletaConverter implements Converter {

    @Inject
    private BoletaFacade ejbFacade;
